    ...
    <div class = "card card-body mb-3">
      <div class = "row">
        ...
        <div class="col-md-9">
          ...
          <span class="badge badge-success">Public Followers: ${user.follwers}</span>
  ...
  // Show User repos 
    showRepos(repos) {
      ...
      repos.forEach(function(repo) {
        ...
        <div class = "col-md-6">
        <span class="badge badge-primary">Stras: ${repos.stargazers_count}</span>
        <span class="badge badge-secondary">Warchers: ${repos.watchers_count}</span>
